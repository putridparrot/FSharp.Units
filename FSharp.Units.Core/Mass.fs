...
module Mass = 
    ...
    and [<Measure>] tonne = // metric tonne
        ...
        static member toPounds(value : float<tonne>) = lb.create(float value / 0.00045359237)
    ...
    and [<Measure>] lb = // pounds
        ...
        static member toTonnes(value : float<lb>) = tonne.create(float value * 0.00045359237)
