...
module DataTransferRate =
    ...
    type bps = // bits per second
        ...
        static member toMebibitPerSecond(value : float<bps>) = Mibit.create(float value / 1048576.)
    ...
    and [<Measure>] Mbps = // Mega bits per second
        ...
        static member toMebibitPerSecond(value : float<Mbps>) = Mibit.create(float value * 0.953674)
    ...
    and [<Measure>] Mibit = // Mebibit per second
        ...
        static member toMegaBytesPerSecond(value : float<Mibit>) = MBps.create(float value * 0.131072)
