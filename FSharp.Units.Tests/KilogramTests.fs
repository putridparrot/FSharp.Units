...
module KilogramTests =
    ...
    let ``Convert known kilogram to milligram`` () =
        ...
        milligrams
        |> should (equalWithin 0.1) 1.56e+9<mg>
    ...
    let ``Convert known kilogram to gram`` () =
        ...
        grams
        |> should (equalWithin 0.1) 1560000<g>
    ...
    let ``Convert known kilogram to tonne`` () =
        ...
        tonnes
        |> should (equalWithin 0.1) 1.56<tonne>
    ...
    let ``Convert known kilogram to ounce`` () =
        ...
        ounces
        |> should (equalWithin 0.1) 9030.13<oz>
    ...
    let ``Convert known kilogram to pound`` () =
        ...
        pounds
        |> should (equalWithin 0.1) 564.383<lb>
    ...
    let ``Convert known kilogram to stone`` () =
        ...
        stones
        |> should (equalWithin 0.1) 194.3217<stone>