...
module InchTests =
   ...
   // inch to X and back
    ...
    let ``Convert known inch to millimetre`` () =
        ...
        millimetres
        |> should (equalWithin 0.1) 3124.2<mm>
    ...
    let ``Convert known inch to centimetre`` () =
        ...
        centimetres
        |> should (equalWithin 0.1) 142.24<cm>
    ...
    let ``Convert known inch to metre`` () =
        ...
        metres
        |> should (equalWithin 0.1) 3.1242<m>
    ...
    let ``Convert known inch to kilometre`` () =
        ...
        kilometres
        |> should (equalWithin 0.1) 0.0480314<km>
    ...
    let ``Convert known inch to yards`` () =
        ...
        yards
        |> should (equalWithin 0.1) 52.52777778<yard>
    ...
    let ``Convert known inch to miles`` () =
        ...
        miles
        |> should (equalWithin 0.1) 0.02984533<mile>
    ...
    let ``Convert known inch to nauticalmiles`` () =
        ...
        nauticalmiles
        |> should (equalWithin 0.1) 0.1220626<cm>
