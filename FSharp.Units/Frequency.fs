...
module Frequency =
    ...
    type GHz =
        ...
        static member toMegahertz(value : float<GHz>) = MHz.create(float value * 1000.)
    and /// Hertz (Hz) units
        [<Measure>] Hz =
        ...
        static member toKilohertz(value : float<Hz>) = kHz.create(float value / 1000.)
    ...
    and /// Kilohertz (kHz) units
        ...
        static member toHertz(value : float<kHz>) = Hz.create(float value * 1000.)
        /// Converts the supplied Kilohertz value to Megahertz
        static member toMegahertz(value : float<kHz>) = MHz.create(float value / 1000.)
    ...
    and /// Megahertz (MHz) units
        ...
        static member toKilohertz(value : float<MHz>) = kHz.create(float value * 1000.)
        /// Converts the supplied Megahertz value to Gigahertz
        static member toGigahertz(value : float<MHz>) = GHz.create(float value / 1000.)
