...
module Pressure =
    ...
    type atm =
        ...
        static member toPascals(value : float<atm>) = Pa.create(float value * 101325.0)
        /// Converts the supplied Atmospheres value to Torrs
        static member toTorrs(value : float<atm>) = Torr.create(float value * 760.0)
    ...
    and /// Pascals (Pa) units
        ...
        static member toAtmospheres(value : float<Pa>) = atm.create(float value / 101325.0)
    ...
    and /// Torrs (Torr) units
        ...
        static member toAtmospheres(value : float<Torr>) = atm.create(float value / 760.0)
