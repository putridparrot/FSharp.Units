...
module Length =
    ...
    type cm =
        ...
        static member toNauticalMiles(value : float<cm>) = NM.create(float value / 185200.0)
    and /// Feet (ft) units
        [<Measure>] ft =
        ...
        static member toInches(value : float<ft>) = inch.create(float value * 12.0)
        /// Converts the supplied Feet value to Yards
        static member toYards(value : float<ft>) = yard.create(float value / 3.0)
        /// Converts the supplied Feet value to Miles
        static member toMiles(value : float<ft>) = mile.create(float value / 5280.0)
    ...
    and /// Inches (inch) units
        ...
        static member toYards(value : float<inch>) = yard.create(float value / 36.0)
        /// Converts the supplied Inches value to Miles
        static member toMiles(value : float<inch>) = mile.create(float value / 63360.0)
    ...
    and /// Metres (m) units
        ...
        static member toNauticalMiles(value : float<m>) = NM.create(float value / 1852.0)
    and /// Miles (mile) units
        ...
        static member toMillimetres(value : float<mile>) = mm.create(float value * 1609344.0)
        ...
        static member toInches(value : float<mile>) = inch.create(float value * 63360.0)
        /// Converts the supplied Miles value to Feet
        static member toFeet(value : float<mile>) = ft.create(float value * 5280.0)
        /// Converts the supplied Miles value to Yards
        static member toYards(value : float<mile>) = yard.create(float value * 1760.0)
    ...
    and /// Millimetres (mm) units
        ...
        static member toMiles(value : float<mm>) = mile.create(float value / 1609344.0)
        /// Converts the supplied Millimetres value to Nautical Miles
        static member toNauticalMiles(value : float<mm>) = NM.create(float value / 1852000.0)
    and /// Nautical Miles (NM) units
        ...
        static member toMillimetres(value : float<NM>) = mm.create(float value * 1852000.0)
        /// Converts the supplied Nautical Miles value to Centimetres
        static member toCentimetres(value : float<NM>) = cm.create(float value * 185200.0)
        /// Converts the supplied Nautical Miles value to Metres
        static member toMetres(value : float<NM>) = m.create(float value * 1852.0)
    ...
    and /// Yards (yard) units
        ...
        static member toInches(value : float<yard>) = inch.create(float value * 36.0)
        /// Converts the supplied Yards value to Feet
        static member toFeet(value : float<yard>) = ft.create(float value * 3.0)
        /// Converts the supplied Yards value to Miles
        static member toMiles(value : float<yard>) = mile.create(float value / 1760.0)
