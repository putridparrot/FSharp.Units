...
module Speed =
    ...
    type fps =
        ...
        static member toMilesPerHour(value : float<fps>) = mph.create(float value / 1.46667)
        ...
        static member toMetresPerSecond(value : float<fps>) = mps.create(float value / 3.28084)
        /// Converts the supplied Feet Per Second value to Knots
        static member toKnots(value : float<fps>) = knot.create(float value / 1.68781)
    and /// Kilometres Per Hour (kph) units
        ...
        static member toMilesPerHour(value : float<kph>) = mph.create(float value / 1.60934)
        /// Converts the supplied Kilometres Per Hour value to Feet Per Second
        static member toFeetPerSecond(value : float<kph>) = fps.create(float value / 1.09728)
        /// Converts the supplied Kilometres Per Hour value to Metres Per Second
        static member toMetresPerSecond(value : float<kph>) = mps.create(float value / 3.6)
        /// Converts the supplied Kilometres Per Hour value to Knots
        static member toKnots(value : float<kph>) = knot.create(float value / 1.852)
    and /// Knots (knot) units
        ...
        static member toMetresPerSecond(value : float<knot>) = mps.create(float value / 1.94384)
    ...
    and /// Miles Per Hour (mph) units
        ...
        static member toMetresPerSecond(value : float<mph>) = mps.create(float value / 2.23694)
        /// Converts the supplied Miles Per Hour value to Knots
        static member toKnots(value : float<mph>) = knot.create(float value / 1.15078)
